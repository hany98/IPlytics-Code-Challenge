...
public class UpdateDeclarationIntegrationTest {
    ...
    @Test
    public void updateDeclaration_allFieldsValid_201_updated() throws Exception {
        ...
        given(declarationService.updateDeclaration(any())).willReturn(declarationResponse);

        String requestBody = new Gson().toJson(declarationRequest);
        
        mvc.perform(put(declarationEndpoint)
    ...
    @Test
    public void updateDeclaration_missingNonRequiredField_201_updated() throws Exception {
    ...
    @Test
    public void updateDeclaration_missingRequiredField_400_badRequest() throws Exception {
    	// Missing Required Field publicationNumber
    	Patent patent = Patent.builder()
    			.publicationNumber("")
    			.publicationDate(LocalDate.of(2019,1,1))
    			.title("Patent1 Title")
        ...
        given(declarationService.updateDeclaration(any())).willThrow(declarationEmptyFieldException);
    ...
    @Test
    public void updateDeclaration_invalidPatentID_404_notFound() throws Exception {
    	DeclarationRequest declarationRequest = DeclarationRequest.builder()
        ...
        given(declarationService.updateDeclaration(any())).willThrow(patentNotFoundException);
    ...
    @Test
    public void updateDeclaration_invalidStandardID_404_notFound() throws Exception {
    	DeclarationRequest declarationRequest = DeclarationRequest.builder()
    			.publicationNumber("Patent1")
    			.standardId("Invalid")
    			.description("Declaration1 Description")
        ...
        given(declarationService.updateDeclaration(any())).willThrow(standardNotFoundException);
